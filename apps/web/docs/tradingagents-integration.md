...
The supplied `Qber-Aug2026.xls` demonstrates why ingestion requires staging. Its
`stocks` sheet mixes approximately 90 tax-lot rows with allocation-only separator
